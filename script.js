...
if(footer){
  footer.innerHTML=`
    <div class="signature-footer">
      <a class="signature-footer-icon" href="index.html" aria-label="ARTIST53 home">
        <img class="signature-footer-gold-mark" src="artist53-hand-pencil-gold-v2.svg?v=20260810-1745" alt="ARTIST53 hand and pencil icon">
      </a>
  ...
  footerStyles.textContent=`
    ...
    .signature-footer-icon{display:block;width:132px;height:128px;margin-bottom:28px;background:var(--yellow,#ffc31c);-webkit-mask:url('artist53-hand-pencil-gold-v2.svg?v=20260810-1745') center/contain no-repeat;mask:url('artist53-hand-pencil-gold-v2.svg?v=20260810-1745') center/contain no-repeat}
    .signature-footer-gold-mark{display:block;width:100%;height:100%;object-fit:contain;opacity:0}
