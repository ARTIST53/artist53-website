...
if(footer){
  footer.innerHTML=`
    <div class="signature-footer">
      <a class="signature-footer-icon" href="index.html" aria-label="ARTIST53 home"></a>
  ...
  footerStyles.textContent=`
    ...
    .signature-footer-icon{display:block;width:132px;height:128px;margin-bottom:28px;background:var(--yellow,#ffc31c);-webkit-mask-image:linear-gradient(#000 0 0),url('artist53-hand-pencil-gold-v2.svg?v=20260810-1804');-webkit-mask-size:100% 100%,contain;-webkit-mask-position:center,center;-webkit-mask-repeat:no-repeat,no-repeat;-webkit-mask-composite:xor;mask-image:linear-gradient(#000 0 0),url('artist53-hand-pencil-gold-v2.svg?v=20260810-1804');mask-size:100% 100%,contain;mask-position:center,center;mask-repeat:no-repeat,no-repeat;mask-composite:exclude}
