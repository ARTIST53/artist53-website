...
if(menu&&!menu.querySelector('a[href="tshirt-design.html"]')){const link=document.createElement('a');link.href='tshirt-design.html';link.textContent='T-Shirt Design';const before=menu.querySelector('a[href="character-design.html"]');if(before)menu.insertBefore(link,before);else menu.appendChild(link)}
...
const styles=document.createElement('style');styles.textContent=`.logo-gallery{grid-template-columns:repeat(3,minmax(0,1fr));gap:22px}.logo-tile{overflow:hidden;transition:transform .25s ease,border-color .25s ease}.logo-tile:hover{transform:translateY(-5px);border-color:var(--yellow,#ffc31c)}.logo-tile-image{aspect-ratio:1/1;padding:18px!important;overflow:hidden;display:flex;align-items:center;justify-content:center;background:#fff}.logo-tile-image img{display:block;width:100%;height:100%;object-fit:contain;transform:none}.logo-tile[href="logo-left-side-lion.html"] .logo-tile-image{background:#000!important}.logo-tile-copy{padding:20px}.logo-tile-copy h3{font-size:2rem}@media(max-width:900px){.logo-gallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:620px){.logo-gallery{grid-template-columns:1fr}.logo-tile-image{padding:14px!important}}.logo-page .logo-hero-points{width:100vw!important;max-width:none!important;margin:38px 0 0 calc(50% - 50vw)!important;padding:0!important;border:0!important;display:block!important;overflow:hidden!important;background:var(--yellow,#ffc31c)!important;color:#050505!important}.logo-page .logo-hero-points-track{display:flex;width:max-content;will-change:transform;animation:logoHeroMarquee 24s linear infinite}.logo-page .logo-hero-points-group{display:flex;align-items:center;gap:24px;padding:18px 12px;white-space:nowrap;font-family:Bebas,Arial,sans-serif;font-weight:700;font-size:clamp(1.65rem,3vw,2.6rem);line-height:1;letter-spacing:.045em;text-transform:uppercase}.logo-page .logo-hero-points-group b{font-size:.72em;font-weight:700}.logo-page .logo-hero-points span::before{content:none!important}@keyframes logoHeroMarquee{from{transform:translateX(0)}to{transform:translateX(-50%)}}@media(prefers-reduced-motion:reduce){.logo-page .logo-hero-points-track{animation:none}}@media(max-width:620px){.logo-page .logo-hero-points-group{gap:17px;padding:15px 10px;font-size:1.55rem}}footer{padding:72px 18px 52px!important;border-top:1px solid var(--line,#2a2a2a);background:#050505!important}.site-footer{width:min(760px,100%);margin:0 auto;display:flex;flex-direction:column;align-items:center;text-align:center}.site-footer-icon{display:block;width:min(180px,44vw);margin-bottom:24px;cursor:pointer}.site-footer-icon img{display:block;width:100%;height:auto;object-fit:contain;animation:artist53FooterBounce 3s ease-in-out infinite;transform-origin:center}@keyframes artist53FooterBounce{0%,100%{transform:translateY(0)}50%{transform:translateY(-18px)}}.site-footer-socials{display:flex;justify-content:center;gap:22px;flex-wrap:wrap;margin:4px 0 0}.site-footer-socials a{color:var(--yellow,#ffc31c);font-family:Bebas,Arial,sans-serif;font-size:1.35rem;letter-spacing:.06em;text-transform:uppercase;text-decoration:none}.site-footer-socials a:hover{text-decoration:underline}.site-footer-email{margin-top:24px;color:var(--yellow,#ffc31c);font-size:1.05rem;text-decoration:none}.site-footer-copy{margin:16px 0 0;color:#888;font-size:.92rem}.site-footer-tagline{margin:24px 0 0;color:var(--yellow,#ffc31c);font-family:Bebas,Arial,sans-serif;font-size:clamp(1.8rem,4vw,3rem);letter-spacing:.05em;text-transform:uppercase}.site-footer-icon{cursor:pointer}.site-footer-icon img{animation:artist53FooterBounce 2.1s cubic-bezier(.45,0,.55,1) infinite!important;transform-origin:50% 75%;will-change:transform}@keyframes artist53FooterBounce{0%,100%{transform:translateY(0) rotate(0deg)}42%{transform:translateY(-34px) rotate(-2.5deg)}58%{transform:translateY(-34px) rotate(2.5deg)}}`;document.head.appendChild(styles);
...
const footer=document.querySelector('footer');if(footer){footer.innerHTML=`<div class="site-footer"><a class="site-footer-icon" href="#top" aria-label="Back to the top of this page"><img src="artist53-footer-pencil.png?v=20260907" alt="ARTIST53 hand holding a pencil" width="720" height="643"></a><nav class="site-footer-socials" aria-label="ARTIST53 social media"><a href="https://www.instagram.com/artist053/" target="_blank" rel="noopener noreferrer">Instagram</a><a href="https://youtube.com/@artist053?si=jIRie_tqxgwjsKy1" target="_blank" rel="noopener noreferrer">YouTube</a><a href="https://www.facebook.com/Artist53-517267671632498/" target="_blank" rel="noopener noreferrer">Facebook</a></nav><a class="site-footer-email" href="mailto:justin@artist53.com">justin@artist53.com</a><p class="site-footer-copy">© 2026 ARTIST53</p><p class="site-footer-tagline">ART NEVER SLEEPS!</p></div>`;const footerTopLink=footer.querySelector(".site-footer-icon");if(footerTopLink)footerTopLink.addEventListener("click",event=>{event.preventDefault();window.scrollTo({top:0,behavior:window.matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"})});}
...
;
(()=>{if(window.artist53FooterBackToTopReady)return;window.artist53FooterBackToTopReady=true;document.addEventListener("click",event=>{const link=event.target.closest&&event.target.closest(".site-footer-icon");if(!link)return;event.preventDefault();window.scrollTo({top:0,behavior:window.matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"})})})();
